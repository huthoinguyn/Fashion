let sliders = [
  ...
  },
  {
    ...
    content: {
      title:
        "<span class='text-slate-900 font-extrabold uppercase'> The summer edition</span>",
      desc: "<span class='text-slate-900 text-center'>The world of clothing is always changing, as new cultural influences</span>",
    },
  },
];
let indexSlider = 0;
function changeSlider(indexSlider) {
  const sliderTemplate = `
          <h3 class="text-6xl tracking-wide is-fadeIn">
              ...
              <p class="mt-4 mb-9 is-fadeRight font-normal leading-9 text-white text-base">
