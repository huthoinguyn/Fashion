  ...
  <body>
    ...
    <div id="root" class="max-w-screen-2xl w-full mx-auto">
      <div id="cart" class="cart-container fixed inset-0 z-50 hidden">
        <div
          class="fixed max-w-screen-lg h-[600px] z-[999] mx-auto inset-0 top-1/2 -translate-y-[50%] rounded-md bg-white shadow-2xl"
        >
      ...
      <div
        class="banner w-full h-[45px] leading-[45px] text-center bg-gray-200"
      >
        Free shipping for standard order over $100
      </div>
      <header
        class="w-full h-[80px] flex justify-around items-center transition-all bg-white z-50"
      >
        <div class="logo">
        ...
        <div class="action flex items-center">
          ...
          <div id="cart-icon" class="icon relative">
            ...
            <div
              class="cart-noti w-4 h-4 rounded-full absolute -top-2 -right-2 bg-pri hidden justify-center items-center"
            >
          ...
          <aside class="w-[15%] h-full capitalize p-4">
            ...
            <div class="filter">
              ...
              <div class="price-range border-t border-t-gray-200 pt-5 pb-12">
                <h3
                  class="title pb-2 font-semibold text-base leading-7 text-gray-600"
                >
                  Price
                </h3>
                <div class="filter-wrap">
                  ...
                  <div class="filter-interval">
                    <label
                      >from <input type="text" name="min-interval" value="0"
                    /></label>
                    <label
                      >to <input type="text" name="max-interval" value="15000"
                    /></label>
                  </div>
                </div>
              </div>
