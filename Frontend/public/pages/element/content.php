...
<div id="content" class="max-w-screen-xl mx-auto">
    ...
    <div class="featured-products pt-[45px] pb-[105px]">
        ...
        <div class="product-list grid grid-cols-4 gap-7">
            <div class="item1 product-item">
                <div style="
                  background-image: url('./imgs/featured-product-image-01.jpg');
                " class="product-image h-[380px] bg-cover bg-no-repeat bg-center">
                    <!-- <a href="#"> -->
                ...
                <div class="product-info my-8">
                    <a href="#">
                        <div class="product-name text-base mb-1 hover:text-pri">
                            Herschel supply co 25l
                        </div>
                    </a>
                    <div class="product-price">
                        <span class="text-gray-800">$75.00</span>
                    </div>
                </div>
            </div>
            <div class="item2 product-item">
                <div style="background-image: url('./imgs/category-image-02.jpg')" class="product-image h-[380px] bg-cover bg-no-repeat bg-center">
                    <!-- <a href="#"> -->
                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-20 hover:transition-all hover:ease-in-out hover:duration-300 relative overflow-hidden group">
                        <div class="add-cart-btn absolute bottom-4 left-1/2 translate-x-[-50%] translate-y-[100%] opacity-0 text-sm ct-button px-6 py-1">
                            Add to cart
                ...
                <div class="product-info my-8">
                    ...
                    <div class="product-price">
                        <span class="text-gray-800">$92.50</span>
                    </div>
                </div>
            </div>
            <div class="item3 product-item">
                <div style="
                  background-image: url('./imgs/featured-product-image-03.webp');
                " class="product-image h-[380px] bg-cover bg-no-repeat bg-center">
                    <!-- <a href="#"> -->
                    <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-20 hover:transition-all hover:ease-in-out hover:duration-300 relative overflow-hidden group">
                        <div class="add-cart-btn absolute bottom-4 left-1/2 translate-x-[-50%] translate-y-[100%] opacity-0 text-sm ct-button px-6 py-1">
                ...
                <div class="product-info my-8">
                    ...
                    <div class="product-price">
                        <span class="text-gray-800">$165.90</span>
                    </div>
                </div>
            </div>
            <div class="item4 product-item">
                <div style="
                  background-image: url('./imgs/featured-product-image-01.jpg');
                " class="product-image h-[380px] bg-cover bg-no-repeat bg-center">
                    <!-- <a href="#"> -->
