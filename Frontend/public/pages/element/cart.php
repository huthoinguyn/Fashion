    ...
    <div class="fixed max-w-screen-lg h-[600px] z-[999] mx-auto inset-0 top-1/2 -translate-y-[48%] rounded-md bg-white shadow-2xl">
        <div class="wrap cf h-[100%]">
            ...
            <div class="subtotal cf h-[25%]">
                <ul>
                    <li class="totalRow">
                        <span class="label">Subtotal</span><span class="value subtotal">$35.00</span>
                    </li>

                    <li class="totalRow">
                        <span class="label">Shipping</span><span class="value ship">$5.00</span>
                    </li>

                    <li class="totalRow">
                        <span class="label">Tax</span><span class="value tax">$4.00</span>
                    </li>
