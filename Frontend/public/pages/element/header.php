...
<header class="w-full h-[80px] flex justify-around items-center transition-all duration-300 bg-white z-50">
  ...
  <div class="action flex items-center">
    <div class="user icon relative">
      ...
      <div class="user-info hidden absolute rounded-bl-md rounded-br-md shadow-lg top-10 -right-4 w-[200px] p-4 bg-white z-50 justify-between flex-col items-center">
