            ...
            <li class="items odd">
              <div class="infoWrap">
                ...
                <div class="prodSection">
                  ...
                  <h3><?php echo $prod['prodname'] ?></h3>

                  <p> <?php echo $prod['customer'] ?></p>
                </div>
                ...
                <div class="removeWrap">
                  <a href="module/product/feature/edit.php?prodId=<?php echo $prod['cartId'] ?>" class="prodIcon editProd">
                    <span class="prodIcon material-symbols-outlined">
                      edit_note
                    </span>
                  </a>
                  <a href="module/product/handle/handleremove.php?prodId=<?php echo $prod['cartId'] ?>" class="prodIcon remove">
                    <span class="material-symbols-outlined">
                      close
                    </span>
                  </a>
